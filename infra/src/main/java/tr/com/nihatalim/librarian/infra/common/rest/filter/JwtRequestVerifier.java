...
public class JwtRequestVerifier extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (authorizationHeader == null || authorizationHeader.equals("") || !authorizationHeader.startsWith(jwtProperties.getTokenPrefix())) {
        ...
        try {
            ...
            List<Map<String,String>> authorities = (List<Map<String, String>>) body.get(jwtProperties.getAuthoritiesClaimKey());
